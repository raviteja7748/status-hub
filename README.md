...
- editable widget visibility/order from the menu bar app
- editable thresholds, event acknowledgement, notification channel settings, and token management from the menu bar app
- live device/event updates for the macOS menu bar app
- a native macOS menu bar client that logs in and acts as the main control center
